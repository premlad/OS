...
namespace OS
{
	public partial class Login : Form
	{
		...
		private void btnlogin_Click(object sender, EventArgs e)
		{
			...
			{
				DialogResult dialog = MessageBox.Show("Please 'Run as Administrator' or Give Adminstrator Permissions to The Following Software.", "Login", MessageBoxButtons.OK, MessageBoxIcon.Error);
			}
		}
